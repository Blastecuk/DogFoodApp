...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_products_life_stage" AS ENUM('puppy', 'adult', 'senior', 'all');
  CREATE TYPE "public"."enum_products_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__products_v_version_life_stage" AS ENUM('puppy', 'adult', 'senior', 'all');
  CREATE TYPE "public"."enum__products_v_version_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum_supplier_price_proposals_status" AS ENUM('draft', 'submitted', 'approved', 'rejected', 'active');
  CREATE TYPE "public"."enum_promotions_kind" AS ENUM('fixed', 'percentage');
  CREATE TYPE "public"."enum_promotions_status" AS ENUM('draft', 'submitted', 'approved', 'active', 'expired');
  ...
  CREATE TABLE "products" (
  	...
  	"description" jsonb,
  	"life_stage" "enum_products_life_stage",
  	"ingredients" varchar,
  	"image_id" integer,
  	"seo_title" varchar,
  ...
  CREATE TABLE "_products_v" (
  	...
  	"version_life_stage" "enum__products_v_version_life_stage",
  ...
  CREATE TABLE "supplier_price_proposals" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"title" varchar NOT NULL,
  	"supplier_id" integer NOT NULL,
  	"product_id" integer,
  	"supplier_sku" varchar,
  	"cost_pence" numeric NOT NULL,
  	"status" "enum_supplier_price_proposals_status" DEFAULT 'draft' NOT NULL,
  ...
  CREATE TABLE "promotions" (
  	...
  	"description" varchar,
  	"kind" "enum_promotions_kind" DEFAULT 'fixed' NOT NULL,
  	"value_pence" numeric,
  	"first_order_only" boolean DEFAULT true,
  ...
  CREATE TABLE "payload_locked_documents_rels" (
  	...
  	"supplier_price_proposals_id" integer,
  ...
  ALTER TABLE "supplier_price_proposals" ADD CONSTRAINT "supplier_price_proposals_supplier_id_suppliers_id_fk" FOREIGN KEY ("supplier_id") REFERENCES "public"."suppliers"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "supplier_price_proposals" ADD CONSTRAINT "supplier_price_proposals_product_id_products_id_fk" FOREIGN KEY ("product_id") REFERENCES "public"."products"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "payload_locked_documents_rels" ADD CONSTRAINT "payload_locked_documents_rels_supplier_price_proposals_fk" FOREIGN KEY ("supplier_price_proposals_id") REFERENCES "public"."supplier_price_proposals"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "supplier_price_proposals_supplier_idx" ON "supplier_price_proposals" USING btree ("supplier_id");
  CREATE INDEX "supplier_price_proposals_product_idx" ON "supplier_price_proposals" USING btree ("product_id");
  CREATE INDEX "supplier_price_proposals_updated_at_idx" ON "supplier_price_proposals" USING btree ("updated_at");
  CREATE INDEX "supplier_price_proposals_created_at_idx" ON "supplier_price_proposals" USING btree ("created_at");
  ...
  CREATE INDEX "payload_locked_documents_rels_supplier_price_proposals_i_idx" ON "payload_locked_documents_rels" USING btree ("supplier_price_proposals_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "supplier_price_proposals" CASCADE;
  ...
  DROP TYPE "public"."enum_products_life_stage";
  DROP TYPE "public"."enum_products_status";
  DROP TYPE "public"."enum__products_v_version_life_stage";
  DROP TYPE "public"."enum__products_v_version_status";
  DROP TYPE "public"."enum_supplier_price_proposals_status";
  DROP TYPE "public"."enum_promotions_kind";
